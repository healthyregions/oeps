...
### Date: 6/16/2025 
### About: As per issue #121 on the Github, we need to add FIPS columns to all
###   the data CSVs, and we need to also drop the (now deprecated) GEOID column.
###   The easiest way to do this for current CSVs is a one-off script, such as
###   this one.
