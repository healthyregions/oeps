# -*- coding: utf-8 -*-
"""Calculate HCV Access Metrics.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13SNj1lQZxaW1uM4zGkc0oMOAh3VcL1-1
...
ax.set_title('Travel Time to HIV testing facility by Census Tract', fontsize=14)
...
test.drop(remove_fields, axis=1, errors="ignore").to_csv('HCV-TRACT-2025.csv', index=False)

# Download to your local machine. Don't forget to uncomment the last line!
from google.colab import files
files.download('HCV-TRACT-2025.csv')
