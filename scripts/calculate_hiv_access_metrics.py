# -*- coding: utf-8 -*-
"""Calculate HIV Access Metrics.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13MFiB6EOVrYLyKsFBYxrBz2Ko98KRzTS
...
test.drop(remove_fields, axis=1, errors="ignore").to_csv('HIV-TRACT-2025.csv', index=False)

# Download to your local machine. Don't forget to uncomment the last line!
from google.colab import files
files.download('HIV-TRACT-2025.csv')
