# -*- coding: utf-8 -*-
"""Calculate Mental Health Facility Access Metrics.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1WnwFl9Ts3m_KkU2K7cVkQkFtaMY-QxB1
...
ax.set_title('Travel Time to Mental Health facility by Census Tract', fontsize=14)
...
test.drop(remove_fields, axis=1, errors="ignore").to_csv('MhFacility-Tract25.csv', index=False)

# Download to your local machine. Don't forget to uncomment the last line!
from google.colab import files
files.download('MhFacility-Tract25.csv')
