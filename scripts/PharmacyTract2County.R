...
tm_shape(county.Rx) + tm_fill("RxAvTmDr2", style = "fixed", breaks = my_breaks)
tm_shape(county.Rx) + tm_fill("RxAvTmDr",  style = "fixed", breaks = my_breaks)
tm_shape(county.Rx) + tm_fill("RxTmDrP2",  style = "fixed", breaks = my_breaks)
tm_shape(county.Rx) + tm_fill("RxTmDrP",   style = "fixed", breaks = my_breaks)
tm_shape(county.Rx) + tm_fill("RxCtTmDr2", style = "fixed", breaks = my_breaks)
tm_shape(county.Rx) + tm_fill("RxCtTmDr",  style = "fixed", breaks = my_breaks)
tm_shape(county.Rx) + tm_fill("TotTracts", style = "fixed", breaks = my_breaks)
