...
def generate_cli_docs():
    ...
    index_content = [
        ...
        "The CLI provides the following groups of commands for managing "\
            "OEPS data in different contexts.\n\n",
    ]
    for group in sorted(index_groups):
        ...
        for path in sorted(docs_path.glob(f"{group}-*.md")):
            ...
            index_content.append(f"  - [{group} {subcommand}](./{path.stem}.md)\n")
    ...
    for path in docs_path.glob("*.md"):
        with open(path, "a") as o:
            o.write("_This documentation is automatically generated, do not edit this file directly._\n")
